...
const Projects = () => {
  ...
  useEffect(() => {
    ...
    // set initial background if currently active
    if (bgScrollTrigger && bgScrollTrigger.isActive) setBg(projectsBg);
    ...
    return () => {
      ...
      // kill ScrollTriggers that are scoped to this section
