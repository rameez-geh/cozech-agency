...
export const metadata = {
  ...
  description: "Transform your digital presence with COZECH. Professional web and mobile app development, modern UI/UX design, and scalable full-stack solutions for your business.",
  keywords: ["web development", "mobile app development", "UI/UX design", "full-stack development", "branding", "custom software", "CRM software"],
  authors: [{ name: "COZECH" }],
  robots: "index, follow",
  openGraph: {
    type: "website",
  ...
  icons: {
    icon: "/images/socialMedia/svg/Logo-2.svg",
    apple: "/images/socialMedia/svg/Logo-2.svg",
  },
  alternates: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: "Professional web and mobile app development company specializing in modern UI/UX design and scalable full-stack solutions",
              address: {
                "@type": "PostalAddress",
      ...
      <body className={sora.className}>
        <noscript>
          <div style={{ padding: "20px", textAlign: "center", fontFamily: "Arial, sans-serif" }}>
            ...
            <p>JavaScript is required to view this website. Please enable JavaScript in your browser settings.</p>
          </div>
        </noscript>
        {children}
        <Analytics />
